...
describe('Draw Text On Canvas', () => {
  ...
  it('should handle onMouseDown Start Drawing Text Object', () => {
  ...
  it('should handle onMouseMove Drawing Text Object', () => {
  ...
  it('should handle onMouseUp End Drawing Text Object', () => {
