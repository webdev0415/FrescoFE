...
describe('Draw Star On Canvas', () => {
  ...
  it('should handle onMouseDown Start Drawing Star Object', () => {
  ...
  it('should handle onMouseMove Drawing Star Object', () => {
    ...
    expect(onMouseMove(objectState, drawingTool, pointerPositions)).toEqual({
      ...
      star: {
        innerRadius: Math.round(
          Math.min(pointerPositions.x, pointerPositions.y) / 2,
        ),
        outerRadius: Math.min(pointerPositions.x, pointerPositions.y),
        numPoints: 5,
      },
    });
  });

  it('should handle onMouseUp End Drawing Star Object', () => {
